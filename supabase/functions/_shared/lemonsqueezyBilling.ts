...
export function resolveBillingProduct(value: unknown): BillingProductId | null {
  ...
  if (value === "theme.obsidian" || value === "theme.celestial" || value === "theme.sakura" || value === "theme.ember" || value === "theme.glacier" || value === "theme.verdant" || value === "theme.abyss" || value === "elite.monthly") return value;
  return null;
}
