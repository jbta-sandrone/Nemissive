...
function DashboardPage() {
  ...
  const handleRealtimeConversationThemeChanged = useCallback((change: { conversationId: string; themeKey: string }) => {
  ...
  async function setConversationTheme(conversationId: string, themeKey: string) {
    const { data, error } = await supabase.rpc("set_conversation_theme", { target_conversation_id: conversationId, requested_theme_key: themeKey });
    if (error) {
