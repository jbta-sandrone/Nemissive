...
function ConversationOptionsMenu({ conversationId, conversationName, profile, profilePresenceText, isProfileOnline, isArchived, isBlocked, messagingAvailable, isConnected, nicknamesByUserId, participants, currentTheme, onArchivedChange, onDelete, onDisconnect, onNicknameSave, onThemeApply, onContentJump, onUserBlockChange }: Props) {
