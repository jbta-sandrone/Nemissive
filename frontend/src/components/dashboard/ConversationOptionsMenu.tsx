...
function ConversationOptionsMenu({ conversationId, conversationName, profile, profilePresenceText, isProfileOnline, isArchived, isBlocked, messagingAvailable, nicknamesByUserId, participants, currentTheme, onArchivedChange, onDelete, onNicknameSave, onThemeApply, onContentJump, onUserBlockChange }: Props) {
