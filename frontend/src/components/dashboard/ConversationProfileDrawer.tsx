...
function ConversationProfileDrawer({ conversationId, profile, conversationNickname, currentTheme, presenceText, isOnline, returnFocusRef, onClose, onEditNicknames, onChangeTheme, onOpenContent }: Props) {
