...
function ConversationProfileDrawer({ conversationId, profile, accountStatus, conversationNickname, currentTheme, presenceText, isOnline, isBlocked, messagingAvailable = true, returnFocusRef, onClose, onEditNicknames, onChangeTheme, onOpenContent, onBlockChange }: Props) {
  ...
  const visibleProfile = details ? { ...details, username: profile.username, display_name: profile.display_name, avatar_url: profile.avatar_url, avatar_border: profile.avatar_border, profile_banner: profile.profile_banner, account_status: profile.account_status, deleted_at: profile.deleted_at } : profile;
