            ...
            {canApply ? (
              ...
              <div className="mt-5 space-y-3">
                ...
                <section aria-labelledby={`${theme.id}-elite-title`} className="rounded-2xl border border-primary/25 bg-accent p-4">
                  ...
                  <p className="mt-1 text-xs leading-5 text-body">Access Obsidian, Celestial, Sakura, Ember, Glacier, Verdant, and other included Elite benefits while your plan is active.</p>
