      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-3 pb-[max(1rem,env(safe-area-inset-bottom))] sm:p-5 lg:p-6">
        <div className="mx-auto grid w-full max-w-6xl items-start gap-4 lg:grid-cols-[minmax(0,1.65fr)_minmax(18rem,0.75fr)] lg:gap-6">
          ...
          <aside aria-label={`${theme.name} access options`} className="rounded-[1.75rem] border border-border bg-background p-4 shadow-soft sm:p-5 lg:sticky lg:top-0">
            ...
            {current && accessSource === "locked" && <div className="mt-4 rounded-2xl border border-primary/25 bg-accent px-4 py-3"><p className="text-sm font-bold text-heading">Current shared theme</p><p className="mt-1 text-xs leading-5 text-body">A participant with access applied this theme to the conversation. You can view it here, but this does not grant ownership or permission to apply it elsewhere.</p></div>}
            ...
            {canApply ? (
              ...
              <div className="mt-5 space-y-3">
                ...
                <section aria-labelledby={`${theme.id}-elite-title`} className="rounded-2xl border border-primary/25 bg-accent p-4">
                  ...
                  <p className="mt-1 text-xs leading-5 text-body">Access Obsidian, Celestial, Sakura, Ember, Glacier, Verdant, Abyss, Eclipse, Dune, Void, Shinkai, and other included Elite benefits while your plan is active.</p>
