...
type LocalConversationResult =
  | { kind: "accepted"; id: string; profile: ProfileSearchResult; preview: string; timestamp: string; isArchived: boolean; conversation: SelectedConversation }
