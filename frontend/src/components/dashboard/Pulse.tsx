...
function Pulse({ conversations, onConversationSelect }: PulseProps) {
  return (
    <section className="hidden min-h-0 flex-1 flex-col border-t border-border bg-surface lg:flex" aria-labelledby="pulse-heading">
      <header className="shrink-0 px-2 pb-1.5 pt-3 text-center">
        <h2 id="pulse-heading" className="text-[10px] font-bold uppercase tracking-[0.18em] text-primary">Pulse</h2>
      </header>
      <div className="pulse-list min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-1.5 pb-3" role="region" aria-label="Pulse utilities and active connections" tabIndex={0}>
