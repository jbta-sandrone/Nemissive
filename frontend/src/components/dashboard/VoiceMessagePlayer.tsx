...
function VoiceMessagePlayer({ src, durationMs, isLoading, isOutgoing, label, onRetry }: VoiceMessagePlayerProps) {
  ...
  return (
    <div className="chat-voice-player min-w-52 max-w-full" onClick={(event) => event.stopPropagation()}>
